...
class marks(student): #here marks derived class and inherits base class student
    def __init__(self) :#constructor function
...
class result(marks):  #here result derived class and inherits base class marks
    def __init__(self):  #constructor function
